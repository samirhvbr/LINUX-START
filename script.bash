...
EOF
		...
		echo
		echo
		echo "Para que as atualizacoes tenham efeito, eh preciso reiniciar o servico de network"
		echo
		echo
		echo -n " >> Reconfigurando a network................................................"
		sleep 0.5
		echo -e "${YEL} [ OK ] ${ENDCOLOR}"
		echo
		echo
	}
	...
	echo
	echo
	read -p "O IPv4 local do servidor esta correto (${ipv4}) (S/n) ? " choice
	case "$choice" in
	s | S | y | Y)
		echo "OK, nada a ser feito!"
		echo
...
EOF
	...
	echo
	echo
	echo -n " >> Reiniciando servico SSH................................................."
...
install_zabbix() {
	...
	echo
	echo -n " >> Configurando Zabbix Agent..............................................."
...
net() {
	...
	while [ $? != 0 ]; do
		echo
		echo -e "Sem acesso à internet! ${RED}[ERRO]${ENDCOLOR}"
		exit 1
	done
	sleep 0.5
	echo -e "${YEL} [ OK ] ${ENDCOLOR}"
